...
function render_list($path, $files)
{
    ...
    <head>
        ...
        <title>NETDISK OF LOGI</title>
        <link rel="shortcut icon" type="image/x-icon" href="https://vcheckzen.github.io/favicon.webp">
        <!-- <link rel='stylesheet' type='text/css' href='https://fonts.proxy.ustclug.org/css?family=Pinyon+Script'> -->
        ...
        <script>
            function __create__dps(videos) {
                let __metaTag = document.createElement('meta');
                __metaTag.name = 'referrer';
                __metaTag.content = 'no-referrer';
                document.getElementsByTagName('head')[0].appendChild(__metaTag);
        ...
        <style type="text/css">
            ...
            .list-header-container a.back-link{color:#000;display:inline-block;position:absolute;font-size:16px;padding:10px 20px;vertical-align:middle;text-decoration:none}
            .list-container,.list-header-container,.list-wrapper,a.back-link:hover,body{color:#24292e}
            .list-header-container .table-header{line-height:120%;margin:0;border:0 none;padding:10px 25px;text-align:center;font-size:98%;font-weight:400;color:#000;background-color:#f7f7f7}
            ...
            .readme{padding:15px;background-color:#fff;}
    ...
    <body>
    <h1 class="title">
        <a href="<?php echo $config['base_path']; ?>">Netdisk of LOGI</a>
    </h1>
                ...
                if (isset($files['file'])) {
                    ...
                    <div style="margin: 24px 4px 4px; text-align: center">
                        ...
                        ';
                            ...
                            echo '
                        <div id="__dp0" style="display:block;margin:24px"></div>
                        <script>
                            let __videos = [
                                "' . $files['@microsoft.graph.downloadUrl'] . '"
                            ];
                            __create__dps(__videos);
                            let dplayer = document.getElementById("__dp0");
                            dplayer.style.height = 9 * dplayer.clientWidth / 21 + "px";
                        </script>';
